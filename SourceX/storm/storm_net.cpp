...
BOOL SNetCreateGame(
    const char *pszGameName,       // unused.
    const char *pszGamePassword,   // game password set by game creator.
    const char *pszGameStatString, // unused.
    DWORD dwGameType,              // game type.
    ...
    int playerCount,               // max total number of players allowed in the game.
    char *creatorName,             // unused.
    char *a11,                     // unused.
